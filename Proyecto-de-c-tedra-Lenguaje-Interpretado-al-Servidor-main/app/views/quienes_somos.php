...
<div class="contenido">
    ...
    <div class="imagen">Espacio para imagen institucional</div>
    ...
    <div class="imagen">Espacio para imagen de equipo de trabajo</div>
    ...
    <div class="imagen">Espacio para imagen de oficinas</div>
